export function CTASection() {
    return (<section className="relative px-5 py-28 overflow-hidden">
      {/* Glow */}
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href="/verify" className="w-full sm:w-auto rounded-xl bg-primary px-8 py-3.5 text-[0.9375rem] text-white font-semibold hover:bg-primary/90 active:scale-[0.97] transition-all duration-100 shadow-glow-primary">
            Start for Free
          </a>
          <a href="/verify" className="w-full sm:w-auto rounded-xl border border-border bg-surface px-8 py-3.5 text-[0.9375rem] text-muted font-medium hover:border-border/60 hover:text-text hover:bg-surface2 transition-all duration-150">
            View Demo
          </a>
        </div>
