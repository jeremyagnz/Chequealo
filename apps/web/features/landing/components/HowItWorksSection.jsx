const STEPS = [
    {
        ...
        description: 'Paste any news headline, tweet, WhatsApp forward, or statement you want to verify.',
    ...
    },
    {
        ...
        description: 'Four AI models simultaneously search the web and cross-validate the claim against fresh evidence.',
    ...
    },
    {
        ...
        description: 'Receive a credibility score, a clear TRUE/FALSE/MISLEADING verdict, and the full evidence trail.',
...
export function HowItWorksSection() {
    return (<section id="how-it-works" className="relative px-5 py-28 overflow-hidden">
      {/* Gradient backdrop */}
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 relative">
          ...
          <div className="absolute top-10 left-[calc(33.33%+1rem)] right-[calc(33.33%+1rem)] h-px hidden sm:block" aria-hidden="true" style={{
            background: 'linear-gradient(90deg, rgb(var(--color-border)), rgb(var(--color-border-subtle)), rgb(var(--color-border)))',
        }}/>

          {STEPS.map((step, i) => (<div key={step.number} className="relative flex flex-col rounded-2xl border bg-surface p-7 shadow-card" style={{
                borderColor: `rgb(var(--color-border))`,
                animationDelay: `${i * 120}ms`,
            }}>
              {/* Number badge */}
              <div className={`mb-5 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br ${step.color} border ${step.border}`}>
